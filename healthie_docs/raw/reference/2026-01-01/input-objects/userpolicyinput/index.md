---
title: UserPolicyInput | Healthie API Docs
source_url:
  html: https://docs.gethealthie.com/reference/2026-01-01/input-objects/userpolicyinput/index
  md: https://docs.gethealthie.com/reference/2026-01-01/input-objects/userpolicyinput/index.md
---
...
[`onboarding_item_id` ](#field-onboarding-item-id)· [`ID` ](/reference/2026-01-01/scalars/id)· Either ID of related intake flow item which this policy was created for. Usually it is Insurance Form. Email notification will be triggered if this field is passed

## Used By

[`updateUserInput.policies`](/reference/2026-01-01/input-objects/updateuserinput)
