---
title: currentVideoChats | Healthie API Docs
source_url:
  html: https://docs.gethealthie.com/reference/2026-01-01/queries/currentvideochats/index
  md: https://docs.gethealthie.com/reference/2026-01-01/queries/currentvideochats/index.md
---
...
[`only_current` ](#argument-only-current)· [`Boolean`](/reference/2026-01-01/scalars/boolean)

[`user_id` ](#argument-user-id)· [`String` ](/reference/2026-01-01/scalars/string)· User to get current video chats for (if left blank, defaults to current user)
...
```
query currentVideoChats($only_current: Boolean, $user_id: String) {
  currentVideoChats(only_current: $only_current, user_id: $user_id) {
    actual_duration
    add_to_gcal_link
