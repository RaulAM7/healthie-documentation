---
title: provider | Healthie API Docs
source_url:
  html: https://docs.gethealthie.com/reference/2026-01-01/queries/provider/index
  md: https://docs.gethealthie.com/reference/2026-01-01/queries/provider/index.md
---
...
[`organization_info_id` ](#argument-organization-info-id)· [`ID` ](/reference/2026-01-01/scalars/id)· Change provider tax id based off the specified organization info
...
query provider(
  ...
  provider(
    client_id: $client_id
    id: $id
    organization_info_id: $organization_info_id
