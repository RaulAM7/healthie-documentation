...
source_url:
  html: https://docs.gethealthie.com/reference/2026-01-01/queries/courseitem/index
  md: https://docs.gethealthie.com/reference/2026-01-01/queries/courseitem/index.md
---
...
```
query courseItem($course_membership_id: ID, $id: ID) {
  courseItem(course_membership_id: $course_membership_id, id: $id) {
