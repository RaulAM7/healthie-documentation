---
title: nextCourseItem | Healthie API Docs
source_url:
  html: https://docs.gethealthie.com/reference/2026-01-01/queries/nextcourseitem/index
  md: https://docs.gethealthie.com/reference/2026-01-01/queries/nextcourseitem/index.md
---
...
```
query nextCourseItem($id: ID) {
  nextCourseItem(id: $id) {
