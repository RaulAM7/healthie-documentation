...
source_url:
  html: https://docs.gethealthie.com/reference/2026-01-01/queries/featuretoggle/index
  md: https://docs.gethealthie.com/reference/2026-01-01/queries/featuretoggle/index.md
---
...
```
query featureToggle($id: ID, $user_id: ID) {
  featureToggle(id: $id, user_id: $user_id) {
    activity_level
