...
source_url:
  html: https://docs.gethealthie.com/reference/2026-01-01/queries/organizationmembership/index
  md: https://docs.gethealthie.com/reference/2026-01-01/queries/organizationmembership/index.md
---
...
[`user_id` ](#argument-user-id)· [`ID` ](/reference/2026-01-01/scalars/id)· The id of a user

[`id` ](#argument-id)· [`ID` ](/reference/2026-01-01/scalars/id)· The id of an organization membership

## Returns

[`OrganizationMembership`](/reference/2026-01-01/objects/organizationmembership)

## Example

```
query organizationMembership($user_id: ID, $id: ID) {
  organizationMembership(user_id: $user_id, id: $id) {
    ...
    can_request_to_prescribe_controlled_substances
    ...
    can_submit_cms_1500s_to_candid_health
