...
source_url:
  html: https://docs.gethealthie.com/reference/2026-01-01/queries/appointment/index
  md: https://docs.gethealthie.com/reference/2026-01-01/queries/appointment/index.md
---
...
[`id` ](#argument-id)· [`ID` ](/reference/2026-01-01/scalars/id)· The ID of the appointment.

[`include_deleted` ](#argument-include-deleted)· [`Boolean` ](/reference/2026-01-01/scalars/boolean)· When true, deleted appointments can be retrieved via this query.
...
```
query appointment($id: ID, $include_deleted: Boolean) {
