---
title: basicUserInfoFromToken | Healthie API Docs
source_url:
  html: https://docs.gethealthie.com/reference/2026-01-01/queries/basicuserinfofromtoken/index
  md: https://docs.gethealthie.com/reference/2026-01-01/queries/basicuserinfofromtoken/index.md
---
...
```
query basicUserInfoFromToken($token: String) {
  basicUserInfoFromToken(token: $token) {
    access_token
    accessed_account
    active
    active_care_plan
